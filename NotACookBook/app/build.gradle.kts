...
dependencies {
    ...
    implementation(platform("com.google.firebase:firebase-bom:32.0.0")) // BOM to manage Firebase versions
    ...
    implementation("androidx.navigation:navigation-compose:2.8.0") // Ensure this is added
